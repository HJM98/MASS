...
class CalculateClass :
    ...
    def CalculateDirectionValue (self, tempPoint1, tempPoint2, tempPoint3) -> object:
    ...
    def CalculateFinalMotorValue(self, motorSpeed, angleOfBaseExtendeLine,
        ...
        motor=[0,0]
        angleOfFromNowPositionAndObject = angleOfBaseYcordinate - self.imuHeadingAngle[0]
...
tempobjectAllLists = [[200.0, 0.0], [0.0, 300.0], [200.0, 300.0], [400.0, 300.0], [200.0, 600.0], [200.0, 300.0],
                      [200.0, 0.0]]
cal = CalculateClass(1,tempobjectAllLists)

## while
tempgpsPoint = [100.0, 100.0]  ## 외부의 GPS가 '1'개씩 여기로 들어와야 된다.
tempimuHeadingAngle = [-30.0]
cal.CalculateAllMethod(tempgpsPoint, tempimuHeadingAngle)